...
TARGET_ASSERT_MODEL=("SM-A045F" "SM-A045M")
...
TARGET_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME="siop_a12_mt6765"
...
# [
# Disable seamless refresh rate feature as A04 only support up to 60hz
